...
vec3 bump_position(bool is_moon , vec3 s)
{
  ...
  // Replace with your code
    ...
    //--- read bump hieght output ---
    float hieghtAdjust=bump_height(is_moon,s)*10.0;
    
    //--- calculate vec3 (adjust hieght) among normal vector
    vec3 adjustvec=normalize(s)*hieghtAdjust;
    vec3 adjust=s+adjustvec;
